...
import edu.aku.hassannaqvi.kmc_validate_app.contracts.BLRandomContract.singleRandomHH;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String SQL_CREATE_BL_RANDOM = "CREATE TABLE " + BLRandomContract.singleRandomHH.TABLE_NAME + "("
