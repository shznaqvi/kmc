...
import edu.aku.hassannaqvi.kmc_validate_app.databinding.ActivitySectionA2Binding;
...
//        }
    ...
    private void SaveDraft() throws JSONException {
        ...
        sInfo.put("kac02", bi.kac02a.isChecked() ? "1"
        ...
        sInfo.put("kac0296x", bi.kac0296x.getText().toString());
