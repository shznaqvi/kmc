package edu.aku.hassannaqvi.kmc_validate_app.sync;
...
public class SyncAllData extends AsyncTask<Void, Integer, String> {
    ...
    public SyncAllData(Context context, String syncClass, String updateSyncClass, Class contractClass, String url, Collection dbData, View syncStatus, int position, UploadListAdapter adapter, List<SyncModel> uploadlist) {
        mContext = context;
        this.syncClass = syncClass;
        this.updateSyncClass = updateSyncClass;
        this.contractClass = contractClass;
