...
import edu.aku.hassannaqvi.kmc_validate_app.databinding.ActivitySectionB1Binding;
import edu.aku.hassannaqvi.kmc_validate_app.other.DateTimeUtils;
...
//        sc1.put("kba02", bi.kba02.getText().toString());
      ...
      /*  sc1.put("kba04", bi.kba03.getText().toString());
        ...
        sc1.put("kba09dtwin", bi.kba07dtwin.getText().toString());
        sc1.put("kba09mtwin", bi.kba07mtwin.getText().toString());
